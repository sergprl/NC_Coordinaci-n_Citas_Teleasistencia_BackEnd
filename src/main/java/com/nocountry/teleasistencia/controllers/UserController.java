...
import com.nocountry.teleasistencia.controllers.dto.RequestUserDTO;
import com.nocountry.teleasistencia.controllers.dto.ResponseUserDTO;
...
public class UserController {
    ...
    public UserController(UserService userService, PatientService patientService, DoctorService doctorService) {
    ...
    public ResponseEntity<?> create(@Valid @RequestBody RequestUserDTO userDTO, BindingResult result){
        ...
        if (userDTO.getRole().equalsIgnoreCase("PATIENT")){
            ...
            patient.setGenre(userDTO.getGenre());
